...
public class copyMain_Battle_Camera : MonoBehaviour
{
    /* TARGETS
    ...
    */
    ...
    private void ZoomCamera()
    {
        ...
        // Ensure both players are always in frame
        float halfWidth = Mathf.Abs(player.position.x - opponent.position.x) * 0.5f + 1.5f;
        targetZoom = Mathf.Max(targetZoom, halfWidth);
